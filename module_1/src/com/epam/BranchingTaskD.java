...
public class BranchingTaskD {
    public static void main(String[] args) {
        ...
        double[] brickDimensions = new double[3];
        ...
        if (Math.min(a,b) >= brickDimensions[0] && Math.max(a,b) >= brickDimensions[1]) System.out.println ("The aperture matches");
        else System.out.println ("The aperture doesn't match");
    }
}