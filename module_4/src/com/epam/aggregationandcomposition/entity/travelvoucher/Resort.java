...
public class Resort extends Tour {
    public Resort(String location, int distance, BigDecimal priceForOneDay) throws TourLogicalException {
        super(location, distance, priceForOneDay);
    }

    public Resort(String location, int distance, BigDecimal priceForOneDay, Meal includedMeal) throws
